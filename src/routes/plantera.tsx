          ...
          <FadeUp delay={180}>
            <div className="mt-8 rounded-[2rem] bg-mintpapper p-1.5">
              <div className="rounded-[1.6rem] border border-linje bg-white p-8 md:p-10">
                ...
                <div className="mt-8 flex flex-wrap items-center gap-4 border-t border-linje pt-8">
                  {!fallback ? (
                    <button
                      type="button"
                      onClick={toCheckout}
                    ...
                    >
                      <span className="py-2">{busy ? "Öppnar kassan…" : "Till betalning"}</span>
                    ...
                    <div className="rounded-2xl border border-guld/50 bg-guld/10 px-5 py-4">
                      <p className="text-sm font-medium text-skogsgron">Kassan öppnar inom kort.</p>
                  ...
                  <p className="text-xs text-skogsgron/50">
                    Säker betalning via Stripe · kort, Apple Pay och Google Pay
                  </p>
                </div>
              </div>
            </div>
